...
![image](./images/req报文.png)
### 2. 响应报文

![image](./images/resp报文.png)
# 二、HTTP 方法
...
![image](./images/userfeelproxy.png)
- 而反向代理一般位于内部网络中，用户察觉不到。

![image](./images/反向代理.png)
### 2. 网关
